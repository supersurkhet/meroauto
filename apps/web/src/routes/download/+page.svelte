<script lang="ts">
	...
	type Platform = 'android' | 'ios' | 'macos' | 'windows' | 'linux' | 'unknown';
...
<section class="border-t border-gray-100 bg-gray-50 py-16 dark:border-gray-800 dark:bg-gray-800/50">
	<div class="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
		...
		<div class="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
			<!-- Google Play -->
			<a href="#" class="inline-flex items-center gap-3 rounded-xl bg-black px-6 py-3 text-white transition-transform hover:-translate-y-0.5">
